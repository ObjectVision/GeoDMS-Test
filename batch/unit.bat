...
Call Unit\Instance.bat %TstDir%\Unit\operator\cfg\select_orgrel.dms test_log %ResultDir%\unit\operator\select_orgrel.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\points2sequence.dms test_log %ResultDir%\unit\operator\points2sequence.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\reg_count.dms test_log %ResultDir%\unit\operator\reg_count.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\reverse.dms test_log %ResultDir%\unit\operator\reverse.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\reverse_uint8.dms test_log %ResultDir%\unit\operator\reverse_uint8.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\centroid_or_mid_complex.dms test_log %ResultDir%\unit\operator\centroid_or_mid_complex.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\subitem_of_unit.dms test_log %ResultDir%\unit\operator\subitem_of_unit.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\subset.dms test_log %ResultDir%\unit\operator\subset.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\merge_indirect_domainunit.dms test_log %ResultDir%\unit\operator\merge_indirect_domainunit.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Operator\cfg\ReadElems_flag1.dms test_log %ResultDir%\unit\operator\ReadElems_flag1.txt S1 S2 S3
...
Call Unit\InstanceErrorIsOk.bat %TstDir%\Unit\unit\cfg\categorical_unit.dms src/C    %ResultDir%\unit\unit\categorical_unit.txt S1 S2 S3
Call Unit\InstanceErrorIsOk.bat %TstDir%\Unit\unit\cfg\categorical_unit.dms sub/D    %ResultDir%\unit\unit\categorical_unit.txt S1 S2 S3
Call Unit\Instance.bat          %TstDir%\Unit\unit\cfg\categorical_unit.dms test_log %ResultDir%\unit\unit\categorical_unit.txt S1 S2 S3

REM SECTION STORAGE READ
Call Unit\Instance.bat %TstDir%\storage\cfg\regression.dms results/unit_test_log                %ResultDir%\unit\storage\read_geodms_formats.txt S1 S2 S3
Call Unit\instance.bat %TstDir%\storage_gdal\cfg\regression.dms results/unit_test_vect_read_log %ResultDir%\unit\storage\read_gdal_vect_formats.txt S1 S2 S3
Call Unit\instance.bat %TstDir%\Unit\storage\cfg\tiff_configured_domain.dms test_log            %ResultDir%\unit\storage\read_tiff_configured_domain_error.txt S1 S2 S3
...
Call Unit\Instance.bat %TstDir%\Unit\Storage\cfg\write_dbf.dms test_log %ResultDir%\unit\storage\WriteDbf.txt S1 S2 S3
...
Call Unit\Instance.bat %TstDir%\Unit\Storage\cfg\fss_one_record.dms write_data %ResultDir%\unit\storage\fss_one_record.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Storage\cfg\fss_one_record.dms test_log %ResultDir%\unit\storage\fss_one_record.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Storage\cfg\fss_zero_records.dms write_data %ResultDir%\unit\storage\fss_zero_record.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Storage\cfg\fss_zero_records.dms test_log %ResultDir%\unit\storage\fss_zero_record.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Storage\cfg\csv_with_euro.dms test_log %ResultDir%\unit\storage\csv_with_euro.txt S1 S2 S3

REM SECTION TEMPLATE 
Call Unit\Instance.bat %TstDir%\Unit\Template\cfg\read_full.dms test_log %ResultDir%\unit\Template\ReadFullTemplate.txt S1 S2 S3

REM SECTION GRID 
Call Unit\Instance.bat %TstDir%\Unit\grid\cfg\spoint_nrElements.dms test_log %ResultDir%\unit\grid\spoint_nrElements.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\grid\cfg\spoint_ZeroElements.dms test_log %ResultDir%\unit\grid\spoint_ZeroElements.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\grid\cfg\spoint_ZeroElements.dms test_log_to_tiff %ResultDir%\unit\grid\spoint_ZeroElementsToTiff.txt S1 S2 S3

REM SECTION CRS 
Call Unit\Instance.bat %TstDir%\Unit\CRS\cfg\reproject.dms test_log %ResultDir%\unit\crs\reproject.txt S1 S2 S3

REM SECTION OTHER 
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\DoubleInstantiation.dms test_log %ResultDir%\unit\other\DoubleInstantiation.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\DoubleInheritance.dms test_log %ResultDir%\unit\other\DoubleInheritance.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\ComplexNamespaces.dms test_log %ResultDir%\unit\other\ComplexNamespaces.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\Kentallen.dms test_log %ResultDir%\unit\other\Kentallen.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\Overrule.dms test_log %ResultDir%\unit\other\Overrule.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\CombineRangeAndExprTest.dms test_log %ResultDir%\unit\other\CombineRangeAndExprTest.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\TemplateInstAsArg.dms test_log %ResultDir%\unit\other\TemplateInstAsArg.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\InstantiateDataBlock.dms test_log %ResultDir%\unit\other\InstantiateDataBlock.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\GridFromTemplate.dms test_log %ResultDir%\unit\other\GridFromTemplate.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Namespaces\cfg\TemplDefinition.dms test_log %ResultDir%\unit\Namespaces\TemplDefinition.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\CombineDefinedRange.dms test_log %ResultDir%\unit\other\CombineDefinedRange.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\select_with_attr_by_org_rel_nested.dms test_log %ResultDir%\unit\other\select_with_attr_by_org_rel_nested.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\other\cfg\propvalue_inherited_no_subitems.dms test_log %ResultDir%\unit\other\propvalue_inherited_no_subitems.txt S1 S2 S3

Call Unit\Instance.bat %TstDir%\Unit\other\cfg\CloseGUIIssue1.dms test_log %ResultDir%\unit\other\CloseGUIIssue1.txt S1 S2 S3
...
Call Unit\Instance.bat %TstDir%\Unit\Integrity_check\cfg\primary_key_unique.dms test_log %ResultDir%\unit\integrity_check\primary_key_unique.txt S1 S2 S3
Call Unit\InstanceErrorIsOk.bat %TstDir%\Unit\Integrity_check\cfg\primary_key_not_unique.dms test_log %ResultDir%\unit\integrity_check\primary_key_not_unique.txt S1 S2 S3
...
Call Unit\Instance.bat %TstDir%\Unit\Integrity_check\cfg\must_write.dms export %ResultDir%\unit\integrity_check\must_write.txt S1 S2 S3
Call Unit\Instance.bat %TstDir%\Unit\Integrity_check\cfg\must_write.dms test_log %ResultDir%\unit\integrity_check\must_write.txt S1 S2 S3
Call Unit\InstanceErrorIsOk.bat %TstDir%\Unit\Integrity_check\cfg\must_not_write.dms export %ResultDir%\unit\integrity_check\must_not_write.txt S1 S2 S3
